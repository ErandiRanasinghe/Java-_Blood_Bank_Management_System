...
public class ABnegetive extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ABnegetive frame = new ABnegetive();
	...
	public ABnegetive() {
		...
		lblBBloodGroup_1.setBounds(209, 22, 253, 27);
		...
		scrollPane.setBounds(74, 119, 500, 413);
