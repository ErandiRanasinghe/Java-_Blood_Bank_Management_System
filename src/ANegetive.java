...
public class ANegetive extends JFrame {
	...
	public ANegetive() {
		...
		lblABloodGroup.setFont(new Font("Tahoma", Font.BOLD, 20));
		...
		scrollPane.setBounds(74, 94, 425, 448);
